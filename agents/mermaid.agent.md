...
model: ['Grok Code Fast 1 (unify-chat-provider)', 'DeepSeek V3.2 (unify-chat-provider)', 'GPT-5 mini (copilot)', 'GPT-4.1 (copilot)', 'Grok Code Fast 1 (copilot)', 'Raptor mini (copilot)']
# Claude Code fields
