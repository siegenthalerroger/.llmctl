---
name: prd-epic
description: 'Prompt for creating an Epic Product Requirements Document (PRD) for a new epic. This PRD will be used as input for generating a comprehensive technical architecture specification.'
metadata:
  provenance:
    mirror: "https://github.com/github/awesome-copilot/blob/main/skills/breakdown-epic-pm/SKILL.md"
---
