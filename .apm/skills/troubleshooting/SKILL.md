...
description: "Behavioral rules for diagnostic and troubleshooting workflows. Use when diagnosing failures, tool quirks, command hangs, version-dependent behavior, and root-cause analysis before editing configuration. Includes Docker container debugging patterns: terminal state, script execution, entrypoint overrides, and busybox tool differences. Keywords: troubleshoot, diagnose, debug, root cause, logs, version skew, docker, container, secret, hang."
license: ""
---
